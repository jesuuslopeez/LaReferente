...
# Uso: ./organize-images.sh
#
# Mueve archivos con sufijo -small, -medium, -large a sus carpetas correspondientes
# y les quita el sufijo del nombre.
#
# Ejemplo:
#   lamine-yamal-small.png  →  small/lamine-yamal.png
#   lamine-yamal-medium.png →  medium/lamine-yamal.png
#   lamine-yamal-large.png  →  large/lamine-yamal.png
