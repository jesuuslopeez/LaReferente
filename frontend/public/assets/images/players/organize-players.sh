...
# Script para organizar imágenes de jugadores por tamaño
# Uso: ./organize-players.sh
#
# Mueve archivos con sufijo -small, -medium, -large a sus carpetas correspondientes
# y les quita el sufijo del nombre.
#
# Ejemplo:
#   lamine_yamal-small.webp  →  small/lamine_yamal.webp
#   lamine_yamal-medium.webp →  medium/lamine_yamal.webp
#   lamine_yamal-large.webp  →  large/lamine_yamal.webp

echo "🔄 Organizando imágenes de jugadores..."
