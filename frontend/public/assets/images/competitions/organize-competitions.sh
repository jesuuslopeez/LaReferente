...
# Script para organizar imágenes de competiciones por tamaño
# Uso: ./organize-competitions.sh
#
# Mueve archivos con sufijo -small, -medium, -large a sus carpetas correspondientes
# y les quita el sufijo del nombre.
#
# Ejemplo:
#   laliga-small.png  →  small/laliga.png
#   laliga-medium.png →  medium/laliga.png
#   laliga-large.png  →  large/laliga.png

echo "🔄 Organizando imágenes de competiciones..."
